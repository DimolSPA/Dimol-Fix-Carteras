...
namespace Dimol.Reportes.dao
{
    ...
    {
        public static void TraeTitulo(dto.DevolucionDocumentos obj)
        {
            try
            {
        ...
        public static void TraeSucursalCliente(dto.DevolucionDocumentos obj)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        public static void ListarDocumentosDetalle(dto.DevolucionDocumentos obj)
        {
            try
            {
