...
-->
		...
		<fo:root>
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="default-master" page-height="11in"
					...
					<fo:region-body column-count="1" margin-top="0.625in" margin-bottom="0.3125in"/>
					...
					<fo:block>
						<fo:table>
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
										<fo:block font-size="8.75pt" font-family="serif" padding-after="2.5pt" space-before="4.0pt" text-align="left" width="200px" inline-progression-dimension="50%">
											<fo:block>
									...
									<fo:table-cell>
										<fo:block font-size="8.75pt" font-family="serif" padding-after="2.5pt"  space-before="4.0pt" text-align="right">
											<fo:block/>
											<fo:block>
				...
				<!--<fo:static-content flow-name="xsl-region-after">
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell>
									<fo:block font-size="7.5pt" font-family="sans-serif" padding-after="2.5pt"
           ...
           entries -->
				<fo:flow flow-name="xsl-region-body">						
								...
								<fo:table-row>
									<fo:table-cell>
										<fo:block font-size="6.25pt" font-family="serif" padding-after="2.5pt" space-before="5.0pt" text-align="left" width="200px" inline-progression-dimension="50%">
											<fo:block>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Nombre"/>
											</fo:block>
											<fo:block>
												<xsl:text>R.U.T. : </xsl:text>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Rut"/>
											</fo:block>
											<fo:block>
												<xsl:text>GIRO: </xsl:text>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Giro"/>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell>
										<fo:block margin-left="1.25px">
											
										</fo:block>
									</fo:table-cell>
									<fo:table-cell>
									<fo:block margin-left="1.25px"  text-align="right">
											<fo:external-graphic src="url('file:///C:/Archivos/Reportes/XSL/logo-reporte.svg')"  content-height="scale-to-fit" width="90px"  scaling="uniform"  />
										</fo:block>
										<fo:block font-size="6.25pt" font-family="serif" padding-after="2.5pt"  text-align="right">
											<fo:block/>
											<fo:block>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Comuna"/>
												<xsl:text>, </xsl:text>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Region"/>
												<xsl:text>, </xsl:text>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Pais"/>
											</fo:block>
											<fo:block>
												<xsl:text>TELÉFONO: </xsl:text>
												<xsl:value-of select="/CastigoPrejudicialManualCliente/Encabezado/Telefono"/>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
					...
					<xsl:call-template name="title">			
						...
						<xsl:with-param name="cliente" select="/CastigoPrejudicialManualCliente/Titulo/Cliente"/>
						<xsl:with-param name="rutDeudor" select="/CastigoPrejudicialManualCliente/RutUsuario"/>
						<xsl:with-param name="nombreDeudor" select="/CastigoPrejudicialManualCliente/NombreUsuario"/>
						<xsl:with-param name="sucursal" select="/CastigoPrejudicialManualCliente/SucursalCliente"/>
					</xsl:call-template>
					<fo:block/>
					<xsl:call-template name="tabla">
						<xsl:with-param name="filas" select="/CastigoPrejudicialManualCliente"/>
					</xsl:call-template>
	...
	<xsl:template name="title">
		...
		<fo:block font-size="10.0pt" font-family="sans-serif" padding-after="2.5pt" padding-before="11.25px"
			                  space-before="5.0pt" text-align="center">
			<fo:block  font-size="11.25pt" font-family="sans-serif" padding-after="2.5pt"
			                  space-before="2.5pt" text-align="center" font-weight="bold">
			...
			<fo:block font-size="8.75pt" font-family="sans-serif" padding-after="2.5pt"
			                   text-align="left">
				<xsl:text>&#160;</xsl:text>
			</fo:block>
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="left">
							<fo:block>
								<xsl:text>Santiago, </xsl:text><xsl:value-of select="/CastigoPrejudicialManualCliente/FechaComprobante"/>
							</fo:block>
						</fo:table-cell>

						<fo:table-cell text-align="right">
							<fo:block font-weight="bold">
								<xsl:text>FOLIO: </xsl:text><xsl:value-of select="/CastigoPrejudicialManualCliente/Cbcnumero"/><xsl:text>-</xsl:text><xsl:value-of select="/CastigoPrejudicialManualCliente/NumRegistro"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			...
			<fo:block font-weight="bold" font-size="8.75pt" font-family="sans-serif" padding-after="2.5pt"
			                  text-align="left" space-after="3.75pt">
				<xsl:text>De nuestra Consideración: </xsl:text>
			</fo:block>
			<fo:block padding="5px"/>
			<fo:block font-size="8.75pt" font-family="sans-serif" padding-after="2.5pt"
			                  text-align="justify" space-after="3.75pt">
			...
			<fo:block font-size="7.5pt" font-family="serif">
				<fo:table display-align="center">
					...
					<fo:table-body>
						<xsl:choose>
							<xsl:when test="$filas != ''">
								<xsl:for-each select="lstDocs/CastigoPrejudicialManualDetalle">
									<fo:table-row>
				...
				<fo:table-body>	
					<fo:table-row>
						<fo:table-cell number-columns-spanned = "2">
							<fo:block font-size="8.75pt" font-family="sans-serif" padding-after="5.0pt"
										  text-align="justify" space-after="3.75pt">
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-weight="bold" font-size="8.75pt" font-family="sans-serif" padding-after="2.5pt"
										  text-align="left" space-after="3.75pt">
								<xsl:value-of select="/CastigoPrejudicialManualCliente/Empresa"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>	
				</fo:table-body>
