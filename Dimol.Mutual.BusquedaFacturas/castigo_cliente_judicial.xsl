					...
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row>
			                  ...
			                  FECHA EMISION: <xsl:value-of select="/CastigoJudicialCliente/FechaReporte"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
           ...
           entries -->
				<fo:flow flow-name="xsl-region-body">	
								...
								<fo:table-row>
									<fo:table-cell>
										<fo:block font-size="5.0pt" font-family="serif" padding-after="2.0pt" space-before="4.0pt" text-align="left" width="200px" inline-progression-dimension="50%">
											<fo:block>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Nombre"/>
											</fo:block>
											<fo:block>
												<xsl:text>R.U.T. : </xsl:text>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Rut"/>
											</fo:block>
											<fo:block>
												<xsl:text>GIRO: </xsl:text>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Giro"/>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell>
									...
									<fo:block margin-left="1px"  text-align="center">
										...
										<fo:block font-size="5.0pt" font-family="serif" padding-after="2.0pt"  text-align="right">
											<fo:block/>
											<fo:block>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Comuna"/>
												<xsl:text>, </xsl:text>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Region"/>
												<xsl:text>, </xsl:text>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Pais"/>
											</fo:block>
											<fo:block>
												<xsl:text>TELÉFONO: </xsl:text>
												<xsl:value-of select="/CastigoJudicialCliente/Encabezado/Telefono"/>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
					...
					<xsl:call-template name="title">			
						...
						<xsl:with-param name="cliente" select="/CastigoJudicialCliente/Titulo/Cliente"/>
						<xsl:with-param name="rutDeudor" select="/CastigoJudicialCliente/RutUsuario"/>
						<xsl:with-param name="nombreDeudor" select="/CastigoJudicialCliente/NombreUsuario"/>
						<xsl:with-param name="sucursal" select="/CastigoJudicialCliente/SucursalCliente"/>
					</xsl:call-template>
					<fo:block/>
					<xsl:call-template name="tabla">
						<xsl:with-param name="filas" select="/CastigoJudicialCliente"/>
					</xsl:call-template>
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="left">
							<fo:block>
								<xsl:text>Santiago, </xsl:text><xsl:value-of select="/CastigoJudicialCliente/FechaComprobante"/>
							</fo:block>
						</fo:table-cell>

						<fo:table-cell text-align="right">
							<fo:block font-weight="bold">
								<xsl:text>FOLIO: </xsl:text><xsl:value-of select="/CastigoJudicialCliente/Deudor/CbcNumProvCli"/><xsl:text>-</xsl:text><xsl:value-of select="/CastigoJudicialCliente/NumRegistro"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
				...
				<fo:table>
					...
					<fo:table-body>
						<fo:table-row>
							...
							<fo:table-cell padding="2px" text-align="left">
								<fo:block font-weight="bold">
									<fo:inline padding-right="5px"><xsl:value-of select="/CastigoJudicialCliente/RutAbogado"/></fo:inline>
									<xsl:value-of select="/CastigoJudicialCliente/NombreAbogado"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>	
			...
			<fo:block font-size="6.0pt" font-family="serif">
				<fo:table display-align="center">
					...
					<fo:table-body>
						<xsl:choose>
							<xsl:when test="$filas != ''">
								<xsl:for-each select="lstDocs/CastigoJudicialDetalle">
									<fo:table-row>
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block font-weight="bold" font-size="7.0pt" font-family="sans-serif" padding-after="2.0pt" text-align="right" space-after="3.0pt">
								P.P. <xsl:value-of select="/CastigoJudicialCliente/NombreUsuario"/>
							</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					<fo:table-row>
