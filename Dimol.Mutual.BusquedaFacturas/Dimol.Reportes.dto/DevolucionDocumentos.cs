...
{
    [Serializable]
    public class DevolucionDocumentos
    {
        ...
        public List<DevolucionDocumentosDeudor> lstDocsDeudor = new List<DevolucionDocumentosDeudor>();
        public DevolucionDocumentosTotales Totales = new DevolucionDocumentosTotales();
    ...
    public class DevolucionDocumentosCliente
    {
        ...
        public TituloReporte Titulo = new TituloReporte();
        public CabeceraSucursalCliente SucursalCliente = new CabeceraSucursalCliente();
        public DevolucionDocumentosDeudor Deudor = new DevolucionDocumentosDeudor();
        public DevolucionDocumentosTotales Totales = new DevolucionDocumentosTotales();
    ...
    [Serializable]
    public class DevolucionDocumentosDeudor
    {
        public string RutDeudor { get; set; }
        public string NombreDeudor { get; set; }

        public List<CabeceraMotivoCastigo> lstMotivos = new List<CabeceraMotivoCastigo>();
        public List<DevolucionDocumentosDetalle> lstDocs = new List<DevolucionDocumentosDetalle>();
        public DevolucionDocumentosDeudorTotales Totales = new DevolucionDocumentosDeudorTotales();
    }

    [Serializable]
    public class DevolucionDocumentosDeudorTotales
    {
    ...
    [Serializable]
    public class DevolucionDocumentosDetalle
    {
    ...
    [Serializable]
    public class DevolucionDocumentosTotales
    {
        [XmlIgnore]
        public decimal Total { get; set; }
        [XmlElement("Total")]
    ...
    [Serializable]
    public class DevolucionDocumentosBruto
    {
