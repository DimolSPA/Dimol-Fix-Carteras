...
-->
           ...
           entries -->
				<fo:flow flow-name="xsl-region-body">						
					...
					<xsl:call-template name="title">			
						...
						<xsl:with-param name="nombreDeudor" select="/CastigoPrejudicialCliente/Deudor/NombreAsegurado"/>
	...
	<xsl:template name="title">
		...
		<fo:block font-size="8.0pt" font-family="sans-serif" padding-after="2.0pt" padding-before="10px"  space-before="4.0pt" text-align="center">
			...
			<fo:block font-size="7.0pt" font-family="sans-serif" padding-after="2.0pt"
				...
				<xsl:text>De acuerdo a las gestiones efectuadas tendientes a recuperar el crédito encomendado y dado a que las gestiones de cobranza extrajudicial, han resultado infructuosas, recomendamos el castigo contable de los documentos correspondientes a: </xsl:text>
			</fo:block>
