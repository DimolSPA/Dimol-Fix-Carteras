...
function PaisSeleccionado(controlOrigen, controlDestino) {
    ...
    $.ajax({
        type: 'POST',
        url: "/Mantenedor/ListarRegion", // we are calling json method
        dataType: 'json',
        async: false,
...
function CiudadSeleccionada(controlOrigen, controlDestino) {
    ...
    $.ajax({
        type: 'POST',
        url: "/Usuario/ListarComuna", // we are calling json method
        dataType: 'json',
        async: false,
...
function fnGuardarProveedorCliente() {
    $body.addClass("loading");
    //var newUrl = "/Mantenedor/ProveedorCliente/"
    var postData = $("#frmProveedorCliente").serializeArray();

    if ($('#Tipo').val() != "") {
        $.ajax({
            type: 'POST',
            url: "~/Mantenedor/GrabarProveedorCliente/", // we are calling json method
            dataType: 'json',
            traditional: true,
            async: true,
            data: postData,
...
*/
function fnGuardarProveedorCliente() {
    var newUrl = "/Mantenedor/GrabarProveedorCliente/?"
    //FORMULARIO CLIENTE
...
function fnGuardarInsumos() {
    var newUrl = "/Mantenedor/GrabarInsumos/?"
    ...
    function fnGuardarProductos() {
        var newUrl = "/Mantenedor/GrabarProductos/?"
        //FORMULARIO DATOS BASICOS
