...
{
    [RunInstaller(true)]
    public partial class CrearArchivoCopecInstaller : Installer
    {
        public CrearArchivoCopecInstaller()
        {
            InitializeComponent();
        ...
        {
            Assembly service = Assembly.GetAssembly(typeof(CrearArchivoCopecInstaller));
