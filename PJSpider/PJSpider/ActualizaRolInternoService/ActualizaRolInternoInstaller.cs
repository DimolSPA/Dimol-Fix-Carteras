...
{
    [RunInstaller(true)]
    public partial class ActualizaRolInternoInstaller : Installer
    {
        public ActualizaRolInternoInstaller()
        {
            InitializeComponent();
        ...
        {
            Assembly service = Assembly.GetAssembly(typeof(ActualizaRolInternoInstaller));
