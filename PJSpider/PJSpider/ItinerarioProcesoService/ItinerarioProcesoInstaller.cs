...
{
    [RunInstaller(true)]
    public partial class ItinerarioProcesoInstaller : Installer
    {
        public ItinerarioProcesoInstaller()
        {
            InitializeComponent();
        ...
        {
            Assembly service = Assembly.GetAssembly(typeof(ItinerarioProcesoInstaller));
