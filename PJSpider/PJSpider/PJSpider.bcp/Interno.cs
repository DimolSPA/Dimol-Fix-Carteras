...
namespace PJSpider.bcp
{
    public class Interno
    {
        ...
        public static void ActualizarRolesInternos(int inicio, int termino)
        {
        ...
        public static void DescargarListaHTML(RolActualizar s, IWebDriver driver, List<DatoTipo> lstTipoCuaderno)
        {
                ...
                while (error)
                {
                    try
                    {
                        ...
                        if (indicadores.Contains("textoC"))
                        {
                            ...
                            DescargarRolListaHTML(s, lstTipoCuaderno);// lstTipoCuaderno)
                                ...
                                foreach (HtmlNode cuaderno in htmlR.DocumentNode.SelectNodes("//select[@name='CRR_Cuaderno']"))
                                {
                                    ...
                                    foreach (HtmlNode option in cuaderno.SelectNodes("option"))
                                    {
                                        ...
                                        if (Int64.TryParse(idCuaderno, out test) && !string.IsNullOrEmpty(descCuaderno))
                                        {
                                            ...
                                            s.HTML = htmlCuaderno;
                                            ProcesarRolInternoHTML(s, lstTipoCuaderno);
        ...
        public static void ActualizarRolesInternos()
        {
            int inicio = 0;
            string htmlRol = "";
