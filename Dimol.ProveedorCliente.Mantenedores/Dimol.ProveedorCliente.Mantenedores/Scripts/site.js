...
function PaisSeleccionado(controlOrigen, controlDestino) {
    ...
    $.ajax({
        type: 'POST',
        url: "/ProvCli/ListarRegion", // we are calling json method
        dataType: 'json',
        async: false,
...
function RegionSeleccionada(controlOrigen, controlDestino) {
    ...
    $.ajax({
        type: 'POST',
        url: "/ProvCli/ListarCiudad", // we are calling json method
        dataType: 'json',
        async: false,
...
function RegionSel() {
    ...
    $.ajax({
        type: 'POST',
        url: "/Mantenedor/ListarCiudad", // we are calling json method
        dataType: 'json',
        async: false,
...
function CiudadSeleccionada(controlOrigen, controlDestino) {
    ...
    $.ajax({
        type: 'POST',
        url: "/ProvCli/ListarComuna", // we are calling json method
        dataType: 'json',
        async: false,
...
function fnGuardarProveedorCliente() {
    ...
    jsonData.EsPrevisional = document.getElementById('EsPrevisional').checked ? true : false;
    jsonData.Nacionalidad = $("#Nacionalidad").val();
    jsonData.Rut = $("#Rut").val();
    jsonData.Nombre = $("#Nombre").val();
    jsonData.ApellidoPaterno = $("#ApellidoPaterno").val();
    jsonData.ApellidoMaterno = $("#ApellidoMaterno").val();
    jsonData.NombreFantasia = $("#NombreFantasia").val();
    jsonData.Giro = $("#Giro").val();
    jsonData.FechaIngreso = $("#FechaIngreso").val();
    jsonData.Estados = $("#Estados").val();
    jsonData.FechaFin = $("#FechaFin").val();
    jsonData.Transportista = document.getElementById('Transportista').checked ? true : false;
    jsonData.Naviera = document.getElementById('Naviera').checked ? true : false;
    jsonData.Comentario = $("#Comentario").val();
    jsonData.RutRepLegal = $("#RutRepLegal").val();
    jsonData.NombreRepLegal = $("#NombreRepLegal").val();
    jsonData.Mostrar = document.getElementById('Mostrar').checked ? true : false;
    jsonData.TipoCartera = $("#TipoCartera").val();
    jsonData.CodigoSAP = $("#CodigoSAP").val();
    jsonData.Usuario = $("#Usuario").val();

    //FORMULARIO SUCURSAL
    jsonData.NombreSucursal = $("#NombreSucursal").val();
    jsonData.Comuna = $("#Comuna").val();
    jsonData.Direccion = $("#Direccion").val();
    jsonData.Telefono = $("#Telefono").val();
    jsonData.Fax = $("#Fax").val();
    jsonData.Correo = $("#Correo").val();
    jsonData.CasaMatriz = document.getElementById('CasaMatriz').checked ? true : false;
    jsonData.Banco = $("#Banco").val();
    jsonData.TipoCuenta = $("#TipoCuenta").val();
    jsonData.Numero = $("#Numero").val();
    jsonData.CodigoSucursal = $("#CodigoSucursal").val();

    //FORMULARIO IMPUESTO
    jsonData.Impuesto = $("#Impuesto").val();

    //FORMULARIO CONTACTO
    jsonData.Sucursal = $("#Sucursal").val();
    jsonData.TipoContacto = $("#TipoContacto").val();
    jsonData.NombreContacto = $("#NombreContacto").val();
    jsonData.TelefonoContacto = $("#TelefonoContacto").val();
    jsonData.AnexoContacto = $("#AnexoContacto").val();
    jsonData.FaxContacto = $("#FaxContacto").val();
    jsonData.CelularContacto = $("#CelularContacto").val();
    jsonData.CorreoContacto = $("#CorreoContacto").val();

    //FORMULARIO CUENTA CORRIENTE
    jsonData.Tipo = $("#Tipo").val();
    jsonData.FormaDePago = $("#FormaDePago").val();
    jsonData.UtilizaCredito = document.getElementById('UtilizaCredito').checked;
    jsonData.LimiteCredito = $("#LimiteCredito").val();
    jsonData.CreditoConsumido = $("#CreditoConsumido").val();
    jsonData.EstadoCredito = $("#EstadoCredito").val();
    jsonData.ComentarioCuentaCorriente = $("#ComentarioCuentaCorriente").val();

    //FORMULARIO CONTRATO
    jsonData.ContratoCartera = $("#ContratoCartera").val();
    jsonData.FechaInicioContrato = $("#FechaInicioContrato").val();
    jsonData.FechaFinContrato = $("#FechaFinContrato").val();
    jsonData.Indefinido = document.getElementById('Indefinido').checked;
    jsonData.RutContrato = $("#RutContrato").val();
    jsonData.NombreContrato = $("#NombreContrato").val();
    jsonData.InteresClientes = document.getElementById('InteresClientes').checked;
    jsonData.HonorariosClientes = document.getElementById('HonorariosClientes').checked;
        ...
        || $("#FormaDePago").val() == "" || $("#Giro").val() == "")
    {
        ...
        $.ajax({
            type: 'POST',
            url: "/ProvCli/GrabarProveedorCliente",
            dataType: 'json',
            async: true,
            data: jsonData,
            success: function (data) {
...
function fnGuardarReceptores() {
    var newUrl = "/ProvCli/GrabarReceptores/?"
    //FORMULARIO CLIENTE
    newUrl += "tipo=" + "1" + "&Nacionalidad=" + "1" + "&Rut=" + $("#Rut").val()
    + "&Nombre=" + $("#Nombre").val() + "&ApellidoPaterno=" + $("#ApellidoPaterno").val() + "&ApellidoMaterno=" + $("#ApellidoMaterno").val()
    + "&NombreFantasia=" + $("#NombreFantasia").val() + "&Giro=" + "" + "&FechaIngreso=" + ""
    + "&Estado=" + "" + "&FechaFin=" + "" + "&Transportista=" + ""
    + "&Naviera=" + "" + "&Comentario=" + "" + "&RutRepLegal=" + ""
    + "&NombreRepLegal=" + "" + "&Mostrar=" + "" + "&TipoCartera=" + ""
    + "&CodigoSAP=" + "" + "&Usuario=" + ""
    //FORMULARIO SUCURSAL
    + "&NombreSucursal=" + "" + "&Comuna=" + ""
    + "&Direccion=" + $("#Direccion").val() + "&Telefono=" + ""
    + "&Fax=" + "" + "&Correo=" + ""
    + "&CasaMatriz=" + "" + "&Banco=" + ""
    + "&TipoCuenta=" + "" + "&Numero=" + "" + "&CodigoSucursal=" + ""
    //FORMULARIO IMPUESTO
    + "&Impuesto=" + ""
    //FORMULARIO CONTACTO
    + "&Sucursal=" + "" + "&TipoContacto=" + "" + "&NombreContacto=" + ""
    + "&TelefonoContacto=" + "" + "&AnexoContacto=" + ""
    + "&FaxContacto=" + "" + "&CelularContacto=" + ""
    + "&CorreoContacto=" + ""
    //FORMULARIO CUENTA CORRIENTE
    + "&Tipo=" + "" + "&FormaDePago=" + "" + "&UtilizaCredito=" + ""
    + "&LimiteCredito=" + "" + "&CreditoConsumido=" + ""
    + "&EstadoCredito=" + "" + "&ComentarioCuentaCorriente=" + ""
    //FORMULARIO CONTRATO
    + "&ContratoCartera=" + "" + "&FechaInicioContrato=" + ""
    + "&FechaFinContrato=" + "" + "&Indefinido=" + ""
    + "&RutContrato=" + "" + "&NombreContrato=" + ""
    + "&InteresClientes=" + "" + "&HonorariosClientes=" + ""
    ...
    if ( $("#Rut").val() == "" || $("#Nombre").val() == ""
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 0) {
                    alert('El Recptor ya existe');
                }
                if ((data != -1) && (data != 0)){
                    alert('Receptor guardado exitosamente. ID Receptor : ' + data);
                }
               
            },
            error: function (ex) {
                alert('Error al guardar Receptor.' + ex);
            }
