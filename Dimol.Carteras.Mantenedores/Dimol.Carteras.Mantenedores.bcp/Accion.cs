...
namespace Dimol.Carteras.Mantenedores.bcp
{
    ...
    public class Accion : dto.Accion
    {
        ...
        public int ListarAccionesGrillaCount(int codemp, int idioma, string where, string sidx, string sord, int inicio, int limite)
        {
            List<dto.Accion> lstAcciones = new List<dto.Accion>();
            lstAcciones = daoAccion.ListarAccionesGrilla(codemp, idioma, "", "Nombre", "asc", 0, 1000000);
            return lstAcciones.Count;
        }
