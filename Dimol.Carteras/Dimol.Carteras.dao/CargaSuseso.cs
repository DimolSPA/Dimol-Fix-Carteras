...
namespace Dimol.Carteras.dao
{
    public class CargaSuseso
    {
        ...
        public static bool InsertarCargaArchivoInteres(SusesoArchivoInteresModel obj)
        {
            try
            {
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Insertar_Mutual_Ley_Intereses");
                sp.AgregarParametro("FechaPago", obj.FechaPago);
                sp.AgregarParametro("FechaDocumento", obj.FechaDocumento);
                sp.AgregarParametro("TasaInteres", obj.TasaInteres);

                int error = sp.EjecutarProcedimientoTrans();
                return error > 0 ? false : true; //Indica si hubo error
            }
            catch (Exception ex)
            {
                obj.Error = ex.Message;
        ...
        public static bool EliminarInteresesPorFechaPago(SusesoArchivoInteresModel obj)
        {
            try
            {
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Eliminar_Mutual_Ley_Intereses_PorFechaPago");

                sp.AgregarParametro("Mes", obj.FechaPago.Month);
                sp.AgregarParametro("Anio", obj.FechaPago.Year);
        ...
        public static bool InsertarCargaArchivoReajuste(SusesoArchivoReajusteModel obj)
        {
            try
            {
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Insertar_Mutual_Ley_Reajuste");
                sp.AgregarParametro("FechaPago", obj.FechaPago);
                sp.AgregarParametro("Periodo", obj.Periodo);
                sp.AgregarParametro("FechaInicial", obj.FechaInicial);
                sp.AgregarParametro("FechaFinal", obj.FechaFinal);
                sp.AgregarParametro("Reajuste", obj.Reajuste);
        ...
        public static bool EliminarReajustePorFechaPago(SusesoArchivoReajusteModel obj)
        {
            try
            {
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Eliminar_Mutual_Ley_Reajuste_PorFechaPago");
