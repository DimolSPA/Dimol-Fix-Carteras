...
CREATE  FUNCTION [dbo].[_Trae_Honorarios_Aplicaciones] 
(
	@codemp INT,
	@ctcid INT,
	@pclid INT,
...
BEGIN
	...
	DECLARE @honorariosAplicaciones  decimal(15,2)
	DECLARE @honorariosReversas  decimal(15,2)
	-- Add the T-SQL statements to compute the return value here
	select @honorariosAplicaciones = sum(aplicaciones_items.api_honorario)       
	...
	select @honorariosReversas = sum(aplicaciones_items.api_honorario)       
	from aplicaciones_items 
	join dbo.aplicaciones 
	on aplicaciones_items.api_codemp = dbo.aplicaciones.apl_codemp 
	and dbo.aplicaciones_items.api_sucid = dbo.aplicaciones.apl_sucid 
	...
	RETURN isnull(@honorariosAplicaciones, 0) - isnull(@honorariosReversas, 0)
