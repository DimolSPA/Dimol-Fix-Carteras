CREATE PROCEDURE [dbo].[_Listar_PanelQuiebra_Diagrama_Reorganiaciones_Grilla]
(
@codemp int,
@where varchar(1000),
@sidx varchar(255),
...
set @query = @query + 'select PQ.QUIEBRA_ID QuiebraId,
	...
	PQD.FEC_RESOLUCION_REORGANIZACION_BC FECPUBLICACION,
	DATEDIFF(day, PQD.FEC_RESOLUCION_REORGANIZACION_BC, ISNULL(isnull(PQD.FEC_VERIFICACION, PQD.FEC_ACREDITACION_PODER), GETDATE())) dias
...
and r.ROL_ESJID = 10
and PQD.FEC_RESOLUCION_REORGANIZACION_BC IS NOT NULL'
