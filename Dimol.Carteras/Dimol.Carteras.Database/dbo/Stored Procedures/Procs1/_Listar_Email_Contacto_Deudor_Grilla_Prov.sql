...
-- =============================================
-- Author:		Jean Robles from Felipe Muñoz base script
-- Create date: 04-05-2018
-- Description:	Procedimiento para listar telefonos por deudor y cliente para jQgrid
-- =============================================
CREATE PROCEDURE [dbo].[_Listar_Email_Contacto_Deudor_Grilla_Prov]
(
@codemp int,
@ctcid integer, 
@email varchar(200),
...
set @query = @query +'SELECT vdnc.ddc_ctcid Ctcid,  
            ...
            (SELECT ei.eti_descripcion  
             ...
             FROM view_deudores_mail_contactos_prov vdnc
...
begin
set @query = @query + ' and   vdnc.mail = = '+ @email
end
