...
-- =============================================
CREATE PROCEDURE [dbo].[_Buscar_Deudores_Grilla]
(
@codemp int ,
@usrid int ,
@nombre varchar(400) ,
...
set @query = @query + 'select ctc_ctcid Ctcid, 
						ctc_rut Rut, 
						ctc_nombre Nombre, 
						ctc_apepat ApellidoPaterno, 
						ctc_apemat ApellidoMaterno, 
						ctc_nomfant NombreFantasia
						from deudores 
