CREATE Procedure [dbo].[_Trae_Reporte_Devolucion_Castigo_Normal](@cbc_codemp integer, @cbc_sucid integer, @cbc_tpcid integer, @cbc_numero decimal(15), @ctcid numeric(15,0), @idi_idid integer) as
