...
-- =============================================
CREATE PROCEDURE [dbo].[_Listar_Documentos_Castigo_Devolucion_Grilla_Count]
(
@codemp int,
@pclid int,
@ctcid int,
...
set @query = 'select count (Numero) as count from
...
(select sbc.SBC_NOMBRE from SUBCARTERAS  sbc where sbc.SBC_CODEMP = CCB_CODEMP and sbc.SBC_SBCID = CCB_SBCID) Asegurado,
