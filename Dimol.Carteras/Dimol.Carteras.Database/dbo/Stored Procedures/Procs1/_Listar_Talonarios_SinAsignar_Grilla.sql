CREATE PROCEDURE [dbo].[_Listar_Talonarios_SinAsignar_Grilla]
(
@codemp int,
@idTal int,
@idSuc int,
...
set @query = '  select * from
  ...
  view_tipos_cpbtdoc_clasificacion.tpc_nombre as nombre, view_tipos_cpbtdoc_clasificacion.tpc_talonario tipo
...
WHERE  view_tipos_cpbtdoc_clasificacion.tpc_codemp = ' + CONVERT(VARCHAR,@codemp) +'
          and view_tipos_cpbtdoc_clasificacion.tpc_talonario = ''S''
            and view_tipos_cpbtdoc_clasificacion.tpc_tpcid not in   
