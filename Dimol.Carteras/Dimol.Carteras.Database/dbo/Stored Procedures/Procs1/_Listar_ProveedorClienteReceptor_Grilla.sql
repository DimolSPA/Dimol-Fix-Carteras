CREATE PROCEDURE [dbo].[_Listar_ProveedorClienteReceptor_Grilla]
(
@codemp int,
@tipo varchar(255),
@nombre varchar(255),
...
set @query = '  select * from
  ...
  (' set @query = @query + 'select tpc_codemp as codemp, pcl_pclid as ID, pcl_rut as RUT, pcl_nombre as NOMBRE, pcl_apepat as APELLIDOPATERNO,
