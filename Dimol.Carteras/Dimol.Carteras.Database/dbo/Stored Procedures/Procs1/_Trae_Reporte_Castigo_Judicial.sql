...
CREATE procedure [dbo].[_Trae_Reporte_Castigo_Judicial](@cbc_codemp integer, @cbc_sucid integer, @cbc_tpcid integer,  @cbc_desde numeric(15), @cbc_hasta numeric(15), @idi_idid integer) as
