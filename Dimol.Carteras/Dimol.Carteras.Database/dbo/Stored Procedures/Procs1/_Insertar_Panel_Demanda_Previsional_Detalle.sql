...
CREATE PROCEDURE [dbo].[_Insertar_Panel_Demanda_Previsional_Detalle]
(
	@panelId int,
	@userEncargado int,
	@fecEnvio datetime,
...
declare
	...
	if @panelIdExist = 0
	BEGIN
		INSERT INTO PANEL_DEMANDA_PREVISIONAL_DETALLE(PANEL_ID, USRID_ENCARGADO, FEC_ENVIO, FEC_ENTREGA,FEC_INGRESO_TRIBUNAL, COMENTARIOS, USRID_REGISTRO)
