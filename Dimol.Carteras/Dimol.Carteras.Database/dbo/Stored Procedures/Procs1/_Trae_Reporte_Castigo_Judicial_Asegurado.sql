CREATE procedure [dbo].[_Trae_Reporte_Castigo_Judicial_Asegurado](@cbc_codemp integer, @cbc_sucid integer, @cbc_tpcid integer,  @ctc_rut varchar(15), @sbc_rut varchar(15), @idi_idid integer) as
 SELECT DISTINCT view_cabecera_comprobantes.cbc_pclid,   
         ...
         view_datos_geograficos_b.pai_nombre as pais_deudor,   
         view_datos_geograficos_b.reg_nombre as region_deudor,   
         view_datos_geograficos_b.ciu_nombre as ciudad_deudor,   
         view_datos_geograficos_b.com_nombre as comuna_deudor,   
		 ...
		 view_rol_datos.tci_nombre Tipo_Causa   
   ...
   WHERE ( provcli_sucursal.pcs_comid = view_datos_geograficos_a.com_comid ) and  
		 ...
		 ( cartera_clientes_documentos_cpbt_doc.ect_agrupa = 5 ) AND  
         ...
         ( cartera_clientes_documentos_cpbt_doc.ctc_rut = @ctc_rut ) AND 
         ( cartera_clientes_documentos_cpbt_doc.sbc_rut = @sbc_rut ) AND  
