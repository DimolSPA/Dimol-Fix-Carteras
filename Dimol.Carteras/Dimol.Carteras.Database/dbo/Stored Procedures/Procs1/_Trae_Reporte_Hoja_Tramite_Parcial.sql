CREATE Procedure [dbo].[_Trae_Reporte_Hoja_Tramite_Parcial](@rol_codemp integer, @rol_pclid integer, @idi_idid integer, @ctc_id numeric, @rol varchar(20), @ccb_ccbid varchar(8000)) as 
