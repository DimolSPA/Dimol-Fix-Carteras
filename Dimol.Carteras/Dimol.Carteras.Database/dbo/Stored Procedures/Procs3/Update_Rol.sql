...
Create Procedure Update_Rol(@rol_codemp integer, @rol_rolid integer, @rol_pclid numeric (15), @rol_ctcid integer, @rol_numero varchar (20),
									@rol_trbid integer, @rol_tcaid integer, @rol_fecdem datetime,
									@rol_fecrol datetime,  @rol_comentario text, @rol_bloqueo char(1), @rol_prequiebra char(1)) as  
  UPDATE rol  
