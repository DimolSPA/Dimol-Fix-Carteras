...
Create Procedure Update_Gestor(@ges_codemp integer, @ges_sucid integer, @ges_gesid integer, @ges_nombre varchar (500),
										 @ges_telefono integer, @ges_email varchar (100), @ges_tipcart smallint, @ges_comki decimal (8,4),
										 @ges_comhon decimal (8,4), @ges_emplid integer, @ges_remoto char(1), @ges_estado char(1),
