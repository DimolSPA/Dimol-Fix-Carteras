...
create procedure Trae_Reporte_Castigo_PreJud(@cbc_codemp integer, @cbc_sucid integer, @cbc_tpcid integer,  @cbc_desde varchar(20), @cbc_hasta varchar(20), @idi_idid integer) as
  SELECT DISTINCT view_cabecera_comprobantes.cbc_pclid,   
   ...
   WHERE ( provcli_sucursal.pcs_comid = view_datos_geograficos_a.com_comid ) and  
         ...
         ( view_cabecera_comprobantes.cbc_numprovcli >= @cbc_desde ) AND  
         ( view_cabecera_comprobantes.cbc_numprovcli <= @cbc_hasta ) AND  
