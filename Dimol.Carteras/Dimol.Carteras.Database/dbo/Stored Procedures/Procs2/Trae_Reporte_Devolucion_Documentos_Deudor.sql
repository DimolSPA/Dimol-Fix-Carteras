CREATE Procedure Trae_Reporte_Devolucion_Documentos_Deudor(@cbc_codemp integer, @cbc_sucid integer, @cbc_tpcid integer, @cbc_numero decimal(15), @idi_idid integer) as
