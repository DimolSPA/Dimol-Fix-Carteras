CREATE Procedure [dbo].[Trae_Reporte_Informe_PreJudicial_Todo](@ccb_codemp integer, @ccb_pclid integer, @ccb_tipcart integer, @idi_idid integer) as    
...
FROM cartera_clientes_documentos_cpbt_doc,              view_datos_geograficos,              idiomas       
