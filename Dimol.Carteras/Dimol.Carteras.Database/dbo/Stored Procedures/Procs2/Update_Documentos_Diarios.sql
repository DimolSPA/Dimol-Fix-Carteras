...
CREATE Procedure [dbo].[Update_Documentos_Diarios](@ddi_codemp integer, @ddi_sucid integer, @ddi_anio smallint, @ddi_numdoc numeric (15),
...
END CATCH 
  ...
  UPDATE documentos_diarios  
     SET ddi_tpcid = @ddi_tpcid,   
         ddi_tipmov = @ddi_tipmov,   
         ddi_pclid = @ddi_pclid,   
         ddi_propio = @ddi_propio,   
         ddi_bcoid = @ddi_bcoid,   
         ddi_ctacte = @ddi_ctacte,   
         ddi_fecing = @fecing,   
         ddi_fecdoc = @fecdoc,   
         ddi_fecvenc = @fecvenc,   
         ddi_edcid = @ddi_edcid,   
         ddi_numcta = @ddi_numcta,   
         ddi_monto = @ddi_monto,   
         ddi_saldo = @ddi_saldo,   
         ddi_codmon = @ddi_codmon,   
         ddi_tipcambio = @ddi_tipcambio,   
         ddi_titular = @ddi_titular,   
         ddi_rutpag = @ddi_rutpag,   
         ddi_nompag = @ddi_nompag,   
         ddi_ctcid = @ddi_ctcid,   
         ddi_empleado = @ddi_empleado,   
         ddi_emplid = @ddi_emplid,   
         ddi_custodia = @ddi_custodia,   
         ddi_docemp = @ddi_docemp,   
         ddi_pagdir = @ddi_pagdir,   
         ddi_vecesdep = @ddi_vecesdep,   
         ddi_fechadep = @ddi_fechadep,   
         ddi_depositar = @ddi_depositar,   
         ddi_rutdep = @ddi_rutdep,   
         ddi_nomdep = @ddi_nomdep,   
         ddi_nrodep = @ddi_nrodep,   
         ddi_fecdep = @ddi_fecdep,   
         ddi_pendiente = @ddi_pendiente,
         ddi_anioneg = @ddi_anioneg,  
         ddi_negid = @ddi_negid,
         ddi_comentario = @ddi_comentario    
