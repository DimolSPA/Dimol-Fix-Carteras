...
Create Procedure Insertar_Cabecera_Comprobantes(@cbc_codemp integer, @cbc_sucid integer, @cbc_tpcid integer, @cbc_numero numeric (15),
																...
																@cbt_vdeid integer, @cbt_tntid integer, @cbt_tgdid integer, 
                                                                @cbt_ttlid integer, @cbc_exento decimal(15,2), @cbc_pcsid integer, 
