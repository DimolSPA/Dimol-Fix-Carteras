...
Create Procedure Insertar_Productos(@pdt_codemp integer, @pdt_prodid numeric (15), @pdt_codfisico varchar (20), @pdt_nombre varchar (200),
                                            ...
                                            @pdt_catid integer, @pdt_codbarra varchar(20), @pdt_SpcID integer) as
