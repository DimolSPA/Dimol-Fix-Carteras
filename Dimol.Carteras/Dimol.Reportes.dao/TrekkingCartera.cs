    ...
    public class TrekkingCartera
    {
        ...
        public static void ListarCarteraDetalle(dto.TrekkingCartera obj)
        {
            try
            {
                ...
                sp.AgregarParametro("pclid", obj.Pclid);
                sp.AgregarParametro("vencidos", obj.Vencidos);
                ds = sp.EjecutarProcedimiento();
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    foreach (var gestor in lstBruto.Select(o => new { CodGestor = o.CodGestor, NombreGestor = o.NombreGestor }).Distinct())
                    {
                        ...
                        foreach (var cliente in lstBruto.Where(o => o.CodGestor == gestor.CodGestor).Select(o => new { CodCliente = o.CodCliente, RutCliente = o.RutCliente, NombreCliente = o.NombreCliente }).Distinct())
                        {
                            ...
                            {
                                act = ((decimal.Parse(lstBruto.Where(o => o.CodGestor == gestor.CodGestor && o.CodCliente == cliente.CodCliente && o.NumDias >= 0 && o.NumDias <= 7).Select(o => o.CodDeudor).Distinct().Count().ToString()) + decimal.Parse(lstBruto.Where(o => o.CodGestor == gestor.CodGestor && o.CodCliente == cliente.CodCliente && o.NumDias >= 8 && o.NumDias <= 15).Select(o => o.CodDeudor).Distinct().Count().ToString())) / decimal.Parse(lstBruto.Where(o => o.CodGestor == gestor.CodGestor && o.CodCliente == cliente.CodCliente).Select(o => o.CodDeudor).Distinct().Count().ToString())) * 100;
                            }
                        ...
                        {
                            objGestor.TotalGestor.PorcCasos = ((decimal.Parse(lstBruto.Where(o => o.CodGestor == gestor.CodGestor && o.NumDias >= 0 && o.NumDias <= 7).Select(o => o.CodDeudor).Distinct().Count().ToString()) + decimal.Parse(lstBruto.Where(o => o.CodGestor == gestor.CodGestor && o.NumDias >= 8 && o.NumDias <= 15).Select(o => o.CodDeudor).Distinct().Count().ToString())) / decimal.Parse(lstBruto.Where(o => o.CodGestor == gestor.CodGestor).Select(o => o.CodDeudor).Distinct().Count().ToString())) * 100;
                        }

                            if (objGestor.TotalGestor.PorcCasos < 60)
                            {
                                objGestor.TotalGestor.Flag = 1;
                            }
                            else if (objGestor.TotalGestor.PorcCasos >= 60 && objGestor.TotalGestor.PorcCasos <= 80)
                            {
                                objGestor.TotalGestor.Flag = 2;
                            }
                            else
                            {
                                objGestor.TotalGestor.Flag = 3;
                            }
                    ...
                    if (obj.CodGestor != 0)
                    {
                        ...
                        foreach (var deudor in lstBruto.Where(o => o.CodGestor == obj.CodGestor).Select(o => new { CodGestor = o.CodGestor, NombreGestor = o.NombreGestor, CodCliente = o.CodCliente, RutCliente = o.RutCliente, NombreCliente = o.NombreCliente, CodDeudor = o.CodDeudor, RutDeudor = o.RutDeudor, NombreDeudor = o.NombreDeudor, NumDias = o.NumDias }).Distinct())
                        {
                            if (deudor.NumDias > 15)
                            {
                                ...
                                objRank.lstDeudores.Add(new dto.TrekkingCarteraDeudor {
                                    ...
                                    CodCliente = deudor.CodCliente,
                                    RutCliente = deudor.RutCliente,
                                    NombreCliente = deudor.NombreCliente
                                });
                        ...
                        objRank.lstDeudores = objRank.lstDeudores.OrderByDescending(o => o.Categoria).ThenByDescending(o => o.Saldo).ToList();
