...
namespace Dimol.Reportes.dao
{
    public class ArbolJudicial
    {
                    ...
                    { 
                        ...
                        {                                                    
                            ...
                            obj.lstArbol.Add(new dto.ArbolJudicialBruto
                            {
                                ...
                                CodAbogado = Int32.Parse(dr["CodAbogado"].ToString()),
                        ...
                        foreach (string categoria in lstCategorias)
                        {
                            ...
                            objCategoria.Totales.CuentaSinMov = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado) && o.Logica == "SIN MOVIMIENTO").GroupBy(o => new { o.NombreCliente, o.RutDeudor, o.NombreDeudor, o.Rol, o.Tribunal, o.TipoCausa, o.MateriaJudicial, o.EstadoRol, o.FechaJudicial, o.DiasSinGestion, o.Logica, o.Cuenta, o.Categoria, o.Abogado }).Select(o => new dto.ArbolJudicialDetalle { NombreCliente = o.Key.NombreCliente, RutDeudor = o.Key.RutDeudor, NombreDeudor = o.Key.NombreDeudor, Rol = o.Key.Rol, Tribunal = o.Key.Tribunal, TipoCausa = o.Key.TipoCausa, MateriaJudicial = o.Key.MateriaJudicial, EstadoRol = o.Key.EstadoRol, FechaJudicial = o.Key.FechaJudicial, DiasSinGestion = o.Key.DiasSinGestion, Logica = o.Key.Logica, Saldo = o.Sum(s => s.Saldo), Cuenta = o.Key.Cuenta, Categoria = o.Key.Categoria, Abogado = o.Key.Abogado }).Count();
                            objCategoria.Totales.TotalSinMov = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado) && o.Logica == "SIN MOVIMIENTO").Select(s => s.Saldo).Sum();
                            objCategoria.Totales.CuentaConMov = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado) && o.Logica == "CON MOVIMIENTO").GroupBy(o => new { o.NombreCliente, o.RutDeudor, o.NombreDeudor, o.Rol, o.Tribunal, o.TipoCausa, o.MateriaJudicial, o.EstadoRol, o.FechaJudicial, o.DiasSinGestion, o.Logica, o.Cuenta, o.Categoria, o.Abogado }).Select(o => new dto.ArbolJudicialDetalle { NombreCliente = o.Key.NombreCliente, RutDeudor = o.Key.RutDeudor, NombreDeudor = o.Key.NombreDeudor, Rol = o.Key.Rol, Tribunal = o.Key.Tribunal, TipoCausa = o.Key.TipoCausa, MateriaJudicial = o.Key.MateriaJudicial, EstadoRol = o.Key.EstadoRol, FechaJudicial = o.Key.FechaJudicial, DiasSinGestion = o.Key.DiasSinGestion, Logica = o.Key.Logica, Saldo = o.Sum(s => s.Saldo), Cuenta = o.Key.Cuenta, Categoria = o.Key.Categoria, Abogado = o.Key.Abogado }).Count();
                            objCategoria.Totales.TotalConMov = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado) && o.Logica == "CON MOVIMIENTO").Select(s => s.Saldo).Sum();
                            objCategoria.Totales.CuentaTotal = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado)).GroupBy(o => new { o.NombreCliente, o.RutDeudor, o.NombreDeudor, o.Rol, o.Tribunal, o.TipoCausa, o.MateriaJudicial, o.EstadoRol, o.FechaJudicial, o.DiasSinGestion, o.Logica, o.Cuenta, o.Categoria, o.Abogado }).Select(o => new dto.ArbolJudicialDetalle { NombreCliente = o.Key.NombreCliente, RutDeudor = o.Key.RutDeudor, NombreDeudor = o.Key.NombreDeudor, Rol = o.Key.Rol, Tribunal = o.Key.Tribunal, TipoCausa = o.Key.TipoCausa, MateriaJudicial = o.Key.MateriaJudicial, EstadoRol = o.Key.EstadoRol, FechaJudicial = o.Key.FechaJudicial, DiasSinGestion = o.Key.DiasSinGestion, Logica = o.Key.Logica, Saldo = o.Sum(s => s.Saldo), Cuenta = o.Key.Cuenta, Categoria = o.Key.Categoria, Abogado = o.Key.Abogado }).Count();
                            objCategoria.Totales.Total = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado)).Select(s => s.Saldo).Sum();
                            ...
                            cuenta += obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado)).GroupBy(o => new { o.NombreCliente, o.RutDeudor, o.NombreDeudor, o.Rol, o.Tribunal, o.TipoCausa, o.MateriaJudicial, o.EstadoRol, o.FechaJudicial, o.DiasSinGestion, o.Logica, o.Cuenta, o.Categoria, o.Abogado }).Select(o => new dto.ArbolJudicialDetalle { NombreCliente = o.Key.NombreCliente, RutDeudor = o.Key.RutDeudor, NombreDeudor = o.Key.NombreDeudor, Rol = o.Key.Rol, Tribunal = o.Key.Tribunal, TipoCausa = o.Key.TipoCausa, MateriaJudicial = o.Key.MateriaJudicial, EstadoRol = o.Key.EstadoRol, FechaJudicial = o.Key.FechaJudicial, DiasSinGestion = o.Key.DiasSinGestion, Logica = o.Key.Logica, Saldo = o.Sum(s => s.Saldo), Cuenta = o.Key.Cuenta, Categoria = o.Key.Categoria, Abogado = o.Key.Abogado }).Count();
                            total += obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado)).Select(s => s.Saldo).Sum();
                            porcTotal += obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && obj.Abogados.Contains(o.CodAbogado) && o.Logica == "CON MOVIMIENTO").GroupBy(o => new { o.NombreCliente, o.RutDeudor, o.NombreDeudor, o.Rol, o.Tribunal, o.TipoCausa, o.MateriaJudicial, o.EstadoRol, o.FechaJudicial, o.DiasSinGestion, o.Logica, o.Cuenta, o.Categoria, o.Abogado }).Select(o => new dto.ArbolJudicialDetalle { NombreCliente = o.Key.NombreCliente, RutDeudor = o.Key.RutDeudor, NombreDeudor = o.Key.NombreDeudor, Rol = o.Key.Rol, Tribunal = o.Key.Tribunal, TipoCausa = o.Key.TipoCausa, MateriaJudicial = o.Key.MateriaJudicial, EstadoRol = o.Key.EstadoRol, FechaJudicial = o.Key.FechaJudicial, DiasSinGestion = o.Key.DiasSinGestion, Logica = o.Key.Logica, Saldo = o.Sum(s => s.Saldo), Cuenta = o.Key.Cuenta, Categoria = o.Key.Categoria, Abogado = o.Key.Abogado }).Count(); 
                        ...
                        foreach(int abogado in obj.Abogados)
                        {
                            ...
                            objAbo.Codigo = abogado;
                            objAbo.Nombre = obj.lstArbol.Where(o => o.CodAbogado == abogado).Select(o => o.Abogado).First().ToString();

                            foreach (string categoria in lstCategorias)
                            {
                                dto.ArbolJudicialCategoria objCat = new dto.ArbolJudicialCategoria();

                                objCat.lstDetalle = obj.lstArbol.Where(o => o.Categoria == categoria && o.Valido == 1 && o.CodAbogado == abogado).GroupBy(o => new { o.RutCliente, o.NombreCliente, o.RutDeudor, o.NombreDeudor, o.Rol, o.Tribunal, o.Logica, o.Cuenta, o.Categoria, o.Abogado }).Select(o => new dto.ArbolJudicialDetalle { RutCliente = o.Key.RutCliente, NombreCliente = o.Key.NombreCliente, RutDeudor = o.Key.RutDeudor, NombreDeudor = o.Key.NombreDeudor, Rol = o.Key.Rol, Tribunal = o.Key.Tribunal, Logica = o.Key.Logica, Saldo = o.Sum(s => s.Saldo), Cuenta = o.Key.Cuenta, Categoria = o.Key.Categoria, Abogado = o.Key.Abogado }).ToList();
        ...
        public static List<Combobox> ListarAbogados(int codemp, int sucid)
        {
            ...
            {
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Listar_Abogados_Vigentes");
                ...
                if (ds.Tables.Count > 0)
                {
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        lst.Add(new Combobox()
                        {
                            ...
                            Text = ds.Tables[0].Rows[i]["epl_nombre"].ToString()
                        });
                    }
                }
