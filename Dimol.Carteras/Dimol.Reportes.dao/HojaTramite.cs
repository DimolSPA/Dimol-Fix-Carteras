    ...
    public class HojaTramite
    {
        ...
        public static void ListarTramitesDetalle(dto.HojaTramite obj)
        {
            try
            {
                ...
                sp.AgregarParametro("rol", (object)obj.Rol ?? DBNull.Value);
                    ...
                    { 
                        ...
                        {                                                      
                            ...
                            lstBruto.Add(new dto.HojaTramiteBruto
                            {
                                ...
                                RutAsegurado = Dimol.bcp.Funciones.formatearRut(dr["sbc_rut"].ToString()),
                        ...
                        foreach (string rol in lstRoles)
                        {
                            ...
                            List<string> lstAseg = lstBruto.Where(o => o.Rol == rol).Select(o => o.NombreAsegurado).Distinct().ToList();

                            foreach (string item in lstAseg)
                            {
                                objHojaCli.lstAsegurados.Add(new dto.HojaTramiteAsegurado
                                {
                                    Nombre = item
                                });
                            }
        ...
        public static void ListarTramitesDetalleParcial(dto.HojaTramite obj)
        {
            try
            {
                List<dto.HojaTramiteBruto> lstBruto = new List<dto.HojaTramiteBruto>();
                ...
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Trae_Reporte_Hoja_Tramite_Parcial");
                sp.AgregarParametro("rol_codemp", obj.Codemp);
                sp.AgregarParametro("rol_pclid", obj.Pclid);
                sp.AgregarParametro("idi_idid", obj.Idioma);
                sp.AgregarParametro("ctc_id", obj.Ctcid);
