...
namespace Dimol.Reportes.dao
{
    public class Cartera
    {
        ...
        public static string TraeHtmlSiiDeudor(int ctcid)
        {            
            string html = "";
            try
            {
                DataSet ds = new DataSet();
                StoredProcedure sp = new StoredProcedure("_Trae_Html_Sii_Deudor");
            ...
            {
                Dimol.dao.Funciones.InsertarError(ex.Message, ex.StackTrace, "Dimol.Reportes.dao.Cartera.TraeHtmlSiiDeudor", 0);
                return html;
            }
        }
    }
