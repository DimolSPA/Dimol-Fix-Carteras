...
namespace Dimol.Reportes.dto
{
    ...
    public class CastigoJudicial
    {
        ...
        public List<CastigoJudicialDeudor> lstDocsDeudor = new List<CastigoJudicialDeudor>();
        public CastigoJudicialTotales Totales = new CastigoJudicialTotales();
    ...
    [Serializable]
    public class CastigoJudicialCliente
    {
        public int Codemp { get; set; }
        public int Codsuc { get; set; }
        public int Tpcid { get; set; }
        ...
        public TituloReporte Titulo = new TituloReporte();
        public CabeceraSucursalCliente SucursalCliente = new CabeceraSucursalCliente();
        public CastigoJudicialDeudor Deudor = new CastigoJudicialDeudor();
        public CastigoJudicialTotales Totales = new CastigoJudicialTotales();
    ...
    [Serializable]
    public class CastigoJudicialDeudor
    {
        ...
        public List<CastigoJudicialDetalle> lstDocs = new List<CastigoJudicialDetalle>();
        public CastigoJudicialDeudorTotales Totales = new CastigoJudicialDeudorTotales();
    }

    [Serializable]
    public class CastigoJudicialDeudorTotales
    {
    ...
    [Serializable]
    public class CastigoJudicialDetalle
    {
    ...
    [Serializable]
    public class CastigoJudicialTotales
    {
        [XmlIgnore]
        public decimal Total { get; set; }
        [XmlElement("Total")]
    ...
    [Serializable]
    public class CastigoJudicialBruto
    {
