...
function fnGenerarTortaDinamica() {
    var newUrl = "/Cartera/TortaAgrupada/?Pclid=" + $("#frmTortaDinamica #Pclid").val() + "&tipcart=" + $("#frmTortaDinamica #TipoCartera").val() + "&estcpbt=" + $("#frmTortaDinamica #EstadoDocumento").val() + "&codid=" + $("#frmTortaDinamica #CodigoCarga").val() + "&gesid=" + ($("#frmTortaDinamica #Gestor").val() == '' ? 0:$("#frmTortaDinamica #Gestor").val())
    ...
    if ($("#frmEmailMutual input[id=Pclid]").val() != '' && $("#frmEmailMutual input[id=Ctcid]").val() != '') {
        ...
        if (idsOfSelectedRows != '' || $("#frmEmailMutual input[id=Pclid]").val() == 559) {
            ...
            if (mailsDestino.length > 0 && mailsDestino != '') {
                ...
                var newUrl = "/Email/EnviarEmailMutual/?"
