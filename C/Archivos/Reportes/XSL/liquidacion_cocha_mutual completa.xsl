	...
	<xsl:template name="tabla">
		...
		<xsl:for-each select="$filas/LiquidacionDeudor">
			<fo:block  page-break-inside="avoid">
				...
				<fo:block font-size="7.0pt" font-family="sans-serif" padding-after="2.0pt" font-weight="bold" text-align="center" >
						<xsl:text>DETALLE LIQUIDACION</xsl:text>
				</fo:block>
				<fo:block font-size="7.0pt" font-family="sans-serif" padding-after="2.0pt" font-weight="bold" font-style="italic" >
						<xsl:text/>
							...
							<fo:table-row font-size="8.0pt">
								...
								<fo:table-cell text-align="right" border-width="1px" padding="2px">
									<fo:block font-weight="bold" color="blue">
										<xsl:value-of select="Totales/CantidadDocumentos"/>
									</fo:block>
								</fo:table-cell>
