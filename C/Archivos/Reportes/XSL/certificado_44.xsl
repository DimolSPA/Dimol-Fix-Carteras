						...
						<tr>
							<td>
								...
								<p style="text-align: justify;">
									<span style="font-size:12px">
										<span style="font-family:times new roman,times,serif">
											<strong>SOLICITA NOTIFICACIÓN POR EL ARTÍCULO 44 CÓDIGO DE PROCEDIMIENTO CIVIL</strong>
										</span>
									</span>
								</p>
								...
								<p style="text-indent: 5em;text-align: justify;">
									<span style="font-size:12px">
										<span style="font-family:times new roman,times,serif">Que como consta en atestado receptorial, el demandado se encuentra en el lugar del juicio, es por eso que solicito a US., se sirva ordenar notificar por el Art. 44 del Código de Procedimiento Civil.</span>
									</span>
								</p>
								...
								<p style="text-align: justify;">
									<span style="font-size:12px">
										<span style="font-family:times new roman,times,serif"><strong>RUEGO A U.S.: </strong>Acceder a lo solicitado, ordenando se notifique de acuerdo al Art. 44 del Código de Procedimiento Civil.</span>
									</span>
								</p>
