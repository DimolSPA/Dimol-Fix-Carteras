		...
		<fo:root>
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="default-master" page-height="5.5in"
					...
					<fo:region-body column-count="1" margin-bottom="0.25in"/>
           ...
           entries -->
				<fo:flow flow-name="xsl-region-body">
						<fo:table>
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block margin-left="27px">
											<fo:external-graphic src="url('file:///C:/Archivos/Reportes/XSL/logo-reporte.svg')" width="200px" height="30px" />
										</fo:block>
									</fo:table-cell>
									<fo:table-cell>
										<fo:block font-size="7.0pt" font-family="serif" padding-after="2.0pt"  space-before="4.0pt" text-align="right">
					...
					<xsl:call-template name="tabla">
						<xsl:with-param name="filas" select="/RecepcionDocumentos/lstDocumentos"/>
					</xsl:call-template>
		...
		<fo:block font-size="6.0pt" font-family="serif">
			<fo:table display-align="center">
				...
				<fo:table-body>
					<xsl:choose>
						<xsl:when test="$filas != ''">
							<xsl:for-each select="$filas/RecepcionDocumentosDetalle">
								<fo:table-row>
									<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center">
										<fo:block>
									...
									<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="left">
										<fo:block>
											<xsl:value-of select="MotivoCobranza"/>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="left">
										<fo:block>
									...
									<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center">
										<fo:block>
											<xsl:value-of select="DocumentoOriginal"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</xsl:for-each>
					...
					<fo:table-row>
						...
						<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center">
							<fo:block font-weight="bold">
								<xsl:value-of select="/RecepcionDocumentos/Totales/Total"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block/>
