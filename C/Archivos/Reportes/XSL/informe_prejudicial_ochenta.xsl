...
-->
		...
		<fo:layout-master-set>
			<!-- Define the cover page. -->
				<fo:simple-page-master master-name="cover" page-height="11in"
					...
					<!-- Header -->
					<fo:region-before extent="0.625in" region-name="xsl-region-before-cover"  />
					<!-- Footer -->
					...
					<fo:block>
						<fo:table>
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
										<fo:block font-size="6.25pt" font-family="serif" padding-after="2.5pt" space-before="5.0pt" text-align="left" width="200px" inline-progression-dimension="50%">
											<fo:block>
									...
									<fo:block margin-left="1px"  text-align="center">
										...
										<fo:block font-size="6.25pt" font-family="serif" padding-after="2.5pt"  text-align="right">
											<fo:block/>
											<fo:block>
				...
				<fo:static-content flow-name="xsl-region-after">
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell>
									<fo:block font-size="6.25pt" font-family="calibri" padding-after="2.5pt"
			                  space-before="5.0pt" text-align="left">
			                  Pág.  <fo:page-number/> de <fo:page-number-citation ref-id="UltimaPagina"/> 
									</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block font-size="6.25pt" font-family="calibri" padding-after="2.5pt"
			                  space-before="5.0pt" text-align="right">
	...
	<xsl:template name="title">
		...
		<fo:block font-size="10.0pt" font-family="Calibri" padding-after="2.5pt"
			                  space-before="2.5pt" text-align="center">
			<fo:block  font-size="12.5pt" font-family="Calibri" padding-after="2.5pt"
			                   text-align="center">
				<xsl:value-of select="$titulo"/>
			</fo:block>
			<xsl:if test="/InformePrejudicial/Codid != 0">
				<fo:block  font-size="12.5pt" font-family="Calibri" padding-after="2.5pt"
								   text-align="center">
					<xsl:value-of select="$codigo"/>
				</fo:block>
			</xsl:if>	
			<fo:block font-size="13.75pt" font-family="Calibri" padding-after="2.5pt"
			                   text-align="center">
				<xsl:value-of select="$cliente"/>
			</fo:block>
			<fo:block font-size="8.75pt" font-family="Calibri" padding-after="2.5pt"
			                   text-align="center">
	...
	<xsl:template name="tabla">
		...
		<xsl:for-each select="$filas/InformePrejudicialDeudor">
			<fo:block>
				<fo:block font-size="8.75pt" font-family="calibri" padding-after="2.5pt"
					...
					<fo:table font-size="7.5pt" margin="1mm">
						<fo:table-column column-width="40%"/>
						<fo:table-column column-width="40%"/>
						...
						<fo:table-body>
							<fo:table-row>
								...
								<fo:table-cell padding="1px" text-align="left">
									<fo:block>
										<xsl:text>PODER JUDICIAL: </xsl:text><xsl:value-of select="PoderJud"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								...
								<fo:table-cell  padding="1px" text-align="left">
									<fo:block>
										<xsl:text>SII: </xsl:text><xsl:value-of select="Sii"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								...
								<fo:table-cell  padding="1px" text-align="left">
									<fo:block>
										<xsl:text>TERRENO: </xsl:text><xsl:choose><xsl:when test="Terreno > 0"><fo:inline font-family="ZapfDingbats">&#x2714;</fo:inline></xsl:when><xsl:otherwise>X</xsl:otherwise></xsl:choose>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row font-weight="bold" >
								<fo:table-cell padding="1px" text-align="left" number-columns-spanned="3">
									<fo:block>
				...
				<fo:block font-size="8.75pt" font-family="calibri" padding="2mm" font-weight="bold" text-align="left" color="brown" >
						<xsl:text>NEGOCIO:</xsl:text><xsl:value-of select="lstAsegurados/InformePrejudicialAsegurado/lstDetallesPesos/InformePrejudicialDetalle/Negocio"/>
				</fo:block>
				<fo:block font-size="7.5pt" font-family="calibri" padding-after="2.5pt">
				<fo:block font-size="7.5pt" font-family="calibri">
					<fo:table>
						...
						<fo:table-body>
							<xsl:choose>
								<xsl:when test="$filas/InformePrejudicialDeudor != ''">
									<xsl:for-each select="lstDetallesPesos/InformePrejudicialDetalle">
										<fo:table-row font-size="6.25pt">
											<fo:table-cell border-after-style="dashed" border-after-width="0.625pt" padding="2px" text-align="left">
												<fo:block>
											...
											<fo:table-cell border-after-style="dashed" border-after-width="0.625pt" padding="2px" text-align="center">
												<fo:block>
											...
											<fo:table-cell border-after-style="dashed" border-after-width="0.625pt" padding="2px" text-align="right">
												<fo:block>
											...
											<fo:table-cell border-after-style="dashed" border-after-width="0.625pt" padding="2px" text-align="right" color="blue">
												<fo:block>
							...
							<fo:table-row font-size="6.25pt">
								<fo:table-cell text-align="left" border-width="1px" padding="2px" number-columns-spanned="5" border-before-style="solid" border-before-width="1.25pt">
									<fo:block  font-weight="bold" font-style="italic" color="brown">TOTAL NEGOCIO:</fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="right" border-width="1px" padding-top="2px" padding-right="0px"  border-before-style="solid" border-before-width="1.25pt">
								...
								<fo:table-cell text-align="right" border-width="1px" padding="2px" border-before-style="solid" border-before-width="1.25pt">
									<fo:block/>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
				...
				<fo:block font-size="8.75pt" font-family="calibri" padding-after="2.5pt" >
				<fo:block font-size="8.75pt" font-family="calibri" padding-after="2.5pt" font-weight="bold" font-style="italic"  white-space-collapse="false" >
				...
				<fo:block font-size="6.25pt" font-family="calibri">
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row font-size="6.25pt">
								<fo:table-cell text-align="left" border-width="1px" padding="2px" number-columns-spanned="5" font-size="7.5pt" 
								font-family="calibri" padding-after="2.5pt" font-weight="bold" font-style="italic"  color="blue" 
								white-space-collapse="false" border-before-style="solid" border-before-width="1pt">
									<fo:block  font-weight="bold" font-style="italic" >TOTAL <xsl:value-of select="../../NombreFantasia"/></fo:block>
								</fo:table-cell>
							...
							<fo:table-row font-size="8.75pt" color="brown">
								<fo:table-cell text-align="left" border-width="1px" padding="2px" number-columns-spanned="5" font-size="8.75pt" font-family="calibri" padding-after="2.5pt" font-weight="bold" font-style="italic"  color="brown" white-space-collapse="false">
									<fo:block/>
								</fo:table-cell>
								<fo:table-cell text-align="right" border-width="1px" padding-top="2px" padding-right="0px">
									<fo:block/>
		...
		<fo:block font-size="7.5pt" font-family="calibri" padding-top="3px">
					<fo:table>
	...
	<xsl:template name="listaDeudores">
		...
		<fo:block>			
				...
				<fo:block font-size="8.75pt" font-family="calibri" padding-after="2.5pt"
					...
					<fo:table font-size="7.5pt" margin="1mm" display-align="center">
						<fo:table-column column-width="40%"/>
						<fo:table-column column-width="40%"/>
						<fo:table-column column-width="20%"/>
						<fo:table-body>
			...
			<fo:block font-size="6.25pt" font-family="calibri">
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row font-size="6.25pt">
								<fo:table-cell text-align="left" border-width="1px" padding="2px" number-columns-spanned="5" font-size="6.25pt" 
								font-family="calibri" padding-after="2.5pt" font-weight="bold" font-style="italic"  color="blue" 
								white-space-collapse="false" border-before-style="solid" border-before-width="1pt">
