...
-->
           ...
           entries -->
				<fo:flow flow-name="xsl-region-body">
					<xsl:call-template name="title">
						...
						<xsl:with-param name="nomGestor" select="/TortaAgrupada/NombreGestor"/>
						<xsl:with-param name="codCarga" select="/TortaAgrupada/NombreCarga"/>
					</xsl:call-template>
					<fo:block/>
	...
	<xsl:template name="title">
		...
		<xsl:param name="nomGestor"/>
		<xsl:param name="codCarga"/>
		...
		<fo:block font-size="7.0pt" font-family="Calibri" padding-after="2.0pt"
			...
			<fo:block font-size="7.0pt" font-family="Calibri" padding-after="2.0pt"
			                   text-align="center">
				<xsl:value-of select="$nomGestor"/>
			</fo:block>
			<fo:block font-size="7.0pt" font-family="Calibri" padding-after="2.0pt"
			                   text-align="center">
				<xsl:value-of select="$codCarga"/>
			</fo:block>
		</fo:block>
	</xsl:template>
	...
	<xsl:template name="tabla">
					...
					<fo:table display-align="center">
						...
						<fo:table-header>
							...
							<fo:table-row>
								...
								<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center">
									<fo:block font-weight="bold">Nº DEUDORES</fo:block>
								</fo:table-cell>
								<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center">
								...
								<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center"  color="blue">
									<fo:block font-weight="bold" >% SALDO/TOTAL</fo:block>
								</fo:table-cell>
								<!--<fo:table-cell border="solid" border-width="1px" padding="2px" text-align="center">
		...
		<xsl:if test="/TortaAgrupada/Totales != ''">
			<fo:block font-size="7.0pt" font-family="calibri" font-weight="bold" font-style="italic" >
				...
				<fo:block font-size="5.0pt" font-family="calibri" padding-after="10px">
