...
-->
           ...
           entries -->
				<fo:flow flow-name="xsl-region-body">
					<xsl:call-template name="title">
						...
						<xsl:with-param name="codigo" select="/InformeJudicial/CodigoCarga"/>
	...
	<xsl:template name="title">
		...
		<fo:block font-size="10.0pt" font-family="Calibri" padding-after="2.5pt"
			...
			<xsl:if test="/InformeJudicial/Codid != 0">
				<fo:block  font-size="12.5pt" font-family="Calibri" padding-after="2.5pt"
								   text-align="center">
		...
		<xsl:for-each select="$deudor/InformeJudicialDeudor">
			<fo:table keep-together="always">
				<fo:table-column column-width="100%"/>
					<fo:table-body>
						<fo:table-row font-size="7.5pt" keep-together="always">
							<fo:table-cell >
								<fo:block font-size="8.75pt" font-family="calibri" padding-left="8px" font-weight="bold" text-align="left" color="firebrick" font-style="italic" keep-together.within-column="always">
						...
						<fo:table-row font-size="7.5pt" >
							<fo:table-cell  >
								<fo:block font-size="7.5pt" font-family="calibri" padding-bottom="1px">
									<xsl:if test="Totales/NroHijos > 1">
											<fo:table>
												...
												<fo:table-body>
													<fo:table-row font-size="7.5pt" >
														<fo:table-cell  padding="2px" text-align="left" font-weight="bold"  color="firebrick"  border-before-style="solid" border-before-width="1.25pt">
															<fo:block>
																<xsl:value-of select="Totales/Cantidad"/> Documentos para el RUT <xsl:value-of select="RutDeudorFormateado"/>   
															</fo:block>
														</fo:table-cell>
														<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="firebrick"  border-before-style="solid" border-before-width="1.25pt">
															<fo:block>
				...
				<fo:table-column column-width="100%"/>
					<fo:table-body>
						<fo:table-row font-size="7.5pt">
							<fo:table-cell >
										<fo:block font-size="8.75pt" font-family="calibri" padding-after="2.5pt"
											  space-before="2.5pt" text-align="center"  widows="4" orphans="4" 
											  border-style="solid" border-width="1" border-color="#000" keep-together.within-column="always">
												<fo:table font-size="7.5pt" margin="1mm" widows="4" orphans="4" >
													...
													<fo:table-body>
														...
														<fo:table-row >
															<fo:table-cell padding="1px" text-align="left" number-columns-spanned="5">
																<fo:block>
	...
	<xsl:template name="listaDocumentos">
		...
		<xsl:if test=". != ''">
				<fo:block font-size="7.5pt" font-family="calibri" padding-after="2.5pt" widows="4" orphans="4">
				<fo:block font-size="7.5pt" font-family="calibri">
					<fo:table>
						...
						<fo:table-body>
							...
							<fo:table-row font-size="7.5pt" >
								<fo:table-cell text-align="left" border-width="1px" padding="2px" number-columns-spanned="4" border-before-style="solid" border-before-width="1.25pt">
								...
								<fo:table-cell text-align="right" border-width="1px" padding-top="2px" padding-right="0px" border-before-style="solid" border-before-width="1.25pt" number-columns-spanned="2">
