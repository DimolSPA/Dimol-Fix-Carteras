...
-->
	...
	<xsl:template name="codigoCarga">
		...
		<xsl:for-each select="$codigo/InformeJudicialCodigoCarga">
			<fo:block font-size="7.0pt" font-family="calibri" padding-left="0mm" font-weight="bold" text-align="left" color="darkslateblue" font-style="italic">
						<xsl:text>CODIGO CARGA:</xsl:text><xsl:value-of select="CodigoCarga"/>
			</fo:block>
			<xsl:call-template name="listaAsegurados">
				<xsl:with-param name="asegurado" select="lstAsegurados"/>
			</xsl:call-template>
			<fo:block font-size="6.0pt" font-family="calibri" padding-bottom="1px"  keep-together.within-column="always">
					<fo:table>
						<fo:table-column column-width="60%"/>
						<fo:table-column column-width="40%"/>
						<fo:table-body>
							<fo:table-row font-size="6.0pt">
								<fo:table-cell  padding="2px" text-align="left" font-weight="bold"  color="darkslateblue"  border-before-style="solid" border-before-width="1pt">
									<fo:block>
										<xsl:value-of select="Totales/Cantidad"/> Documentos por Codigo de Carga <xsl:value-of select="CodigoCarga"/>  
									</fo:block>
								</fo:table-cell>
								<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="darkslateblue"  border-before-style="solid" border-before-width="1pt">
									<fo:block>
							...
							<fo:table-row font-size="6.0pt">
								<fo:table-cell  padding="2px" text-align="left" font-weight="bold"  color="darkslateblue" >
									<fo:block>
										
									</fo:block>
								</fo:table-cell>
								<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="darkslateblue"  >
									<fo:block>
							...
							<fo:table-row font-size="6.0pt">
								...
								<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="darkslateblue"  >
									<fo:block>
										Total por codigo de carga <xsl:value-of select="Totales/Total"/>
									</fo:block>
								</fo:table-cell>
								</fo:table-row>
						</fo:table-body>
		...
		<fo:block>
			...
			<fo:block font-size="6.0pt" font-family="calibri" padding-bottom="1px"  keep-together.within-column="always">
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row font-size="6.0pt">
								<fo:table-cell  padding="2px" text-align="left" font-weight="bold"  color="seagreen"  border-before-style="solid" border-before-width="1pt">
									<fo:block>
										<xsl:value-of select="Totales/Cantidad"/> Documentos para el asegurado <xsl:value-of select="SubCartera"/>  
									</fo:block>
								</fo:table-cell>
								
								<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="seagreen"  border-before-style="solid" border-before-width="1pt">
									<fo:block>
										Saldo Capital <xsl:value-of select="Totales/Capital"/>
									</fo:block>
								</fo:table-cell>
														...
														<fo:table-row font-size="6.0pt">
								<fo:table-cell  padding="2px" text-align="left" font-weight="bold"  color="seagreen"  >
									<fo:block>
						
									</fo:block>
								</fo:table-cell>
								
								<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="seagreen" >
									<fo:block>
										Gastos <xsl:value-of select="Totales/Gasto"/>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell  padding="2px" text-align="right" font-weight="bold" color="seagreen"  >
									<fo:block>
										Total asegurado <xsl:value-of select="Totales/Total"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
	...
	<xsl:template name="listaDocumentos">
		...
		<xsl:if test=". != ''">
				<fo:block font-size="6.0pt" font-family="calibri" padding-after="2.0pt" page-break-inside="avoid">
